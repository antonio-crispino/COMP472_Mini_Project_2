class Node:
  ...
  def __init__(self, parent_node, game_state, depth, use_g, use_h, use_f, heuristic):
    """
    ...
    self.action = game_state.change["direction_moved"]            # String: The action (direction) performed to arrive at the current node
  ...
  @classmethod
  def generate_initial_node(cls, game_state, use_g, use_h, use_f, heuristic = None):
    """
